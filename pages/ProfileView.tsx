...
import { User, Bell, Shield, Heart, MapPin, ChevronRight, LogOut, Settings, Sun, Moon, Package, HandHeart } from 'lucide-react';
...
const ProfileView: React.FC<ProfileViewProps> = ({ darkMode, onToggleTheme, currentUser, listings, onLogout }) => {
  const foodsPosted = listings.filter(l => l.donorEmail === currentUser.email).length;
