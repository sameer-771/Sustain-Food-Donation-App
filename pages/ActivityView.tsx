...
const iconMap: Record<string, React.ReactNode> = {
  ...
  feedback: <Bell size={18} className="text-violet-500" />,
};
        ...
        <div className="space-y-3">
          {notifications.map((notif, idx) => (
            <motion.div
              ...
              className={`glass-panel rounded-2xl p-4 flex items-start gap-3.5 shadow-sm transition-all ${notif.read ? 'opacity-70' : 'border-l-4 border-l-ios-blue'}`}
            >
